...
export function PricingBg() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      blob(W * (0.25 + s * 0.08), H * (0.3 + c * 0.1), W * 0.42, 255, 122, 61, 0.14)
      blob(W * (0.8 + c * 0.06), H * (0.7 + s * 0.08), W * 0.38, 37, 99, 235, 0.12)
      blob(W * (0.5 + s * 0.05), H * (0.55 + c * 0.06), W * 0.3, 255, 140, 80, 0.07)
